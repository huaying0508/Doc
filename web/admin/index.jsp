...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="./index.html">文档分享后台界面</a></div>
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item"><a href="javascript:;">
            ${sessionScope.usertest.adname} </a>
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li><a href="javascript:;"> <i class="iconfont left-nav-li" lay-tips="会员管理">&#xe6b8;</i> <cite>会员管理</cite>
                <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li><a onclick="xadmin.add_tab('用户查询','../user/UserM!findByUser.action',true)"> <i
                            class="iconfont">&#xe6a7;</i>
                        <cite>用户查询</cite></a></li>
                    <li><a onclick="xadmin.add_tab('用户管控','../admin/AddUser.jsp',true)"> <i
                            class="iconfont">&#xe6a7;</i>
                        <cite>添加用户</cite></a></li>
                </ul>
            </li>
            <li><a href="javascript:;"> <i class="iconfont left-nav-li" lay-tips="文档管理">&#xe723;</i> <cite>文档管理</cite>
                <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li><a onclick="xadmin.add_tab('文档审核','../admin/DocAudit.jsp')"> <i class="iconfont">&#xe6a7;</i>
                        <cite>文档审核</cite></a></li>
                    <li><a onclick="xadmin.add_tab('文档配置','../admin/DocConfig.jsp')"> <i class="iconfont">&#xe6a7;</i>
                        <cite>文档配置</cite></a>
                    </li>
                </ul>
            </li>
            <li><a href="javascript:;"> <i class="iconfont left-nav-li" lay-tips="日志管理">&#xe723;</i> <cite>日志管理</cite>
                <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li><a onclick="xadmin.add_tab('日志列表','../admin/LogList.jsp')"> <i class="iconfont">&#xe6a7;</i>
                        <cite>日志列表</cite></a></li>
                </ul>
            </li>
            <li><a href="javascript:;"> <i class="iconfont left-nav-li" lay-tips="系统配置">&#xe723;</i> <cite>系统配置</cite>
                <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li><a onclick="xadmin.add_tab('上传奖励配置','../admin/UploadConfig.jsp')"> <i
                            class="iconfont">&#xe6a7;</i>
                        <cite>上传奖励配置</cite></a></li>
                    <li><a onclick="xadmin.add_tab('注册奖励配置','../admin/ResConfig.jsp')"> <i
                            class="iconfont">&#xe6a7;</i> <cite>注册奖励配置</cite></a>
                    </li>
                </ul>
            </li>
        </ul>
